...
首先非常感谢面试官能给我这次面试的机会。我叫郑俊健，来自广东江门，学历是在读本科。

在校期间的课程主要是java,  SSM, sql server,大多是偏后端的。

但是由于自己比较喜欢前端,所以从大二开始就自学前端, 现在对h5c3,js,e6,vue等前端技术都比较掌握, 后端的话主要是node.js,mongodb或者mysql ,平常用express框架写后台,  其他webpck, git等工具也是有学习使用过的, 自己也写过一些项目, 例如App管理系统,聊天应用,后台管理系统, 都是有用到简历上面写的相关技术。

虽然目前没有实际工作经验, 但是我觉得自己适应力和学习能力比较强。

在校期间参加过学院的新闻记者团, 虽然这个社团对我专业能力没有直接的提升,但是通过参过这个社团,我觉得个人的综合能力得到了提升。

在这里希望能找到一份前端实习的工作。自我介绍完毕,谢谢!
